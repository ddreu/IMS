    ...
    <div class="main-container">
        <div class="main-content">
            ...
            <div class="header-section">
                ...
                <h2 class="text-center mb-4"><?= htmlspecialchars($match['game_name']) ?> - Live Scoring</h2>
            </div>
            ...
            <?php if (!empty($rules['duration_per_period'])): ?>
                <div class="timer-section text-center mb-4">
                    ...
                    <div class="timer-controls">
                        ...
                        <button id="timer-pause" class="btn btn-warning">
                            <i class="fas fa-pause"></i>
                        </button>
                        <button id="timer-end" class="btn btn-danger">
