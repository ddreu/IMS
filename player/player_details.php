        ...
        <div class="container-fluid mt-4">
            <div class="row">
                ...
                <div class="col-12 mb-4">
                    <a href="view_roster.php?team_id=<?= $player['team_id'] ?>&grade_section_course_id=<?= htmlspecialchars($grade_section_course_id) ?>" class="back-button">
                            ...
                            <?php if ($stats_result->num_rows > 0): ?>
                                ...
                                <div class="row mb-4">
                                    ...
                                    foreach ($aggregated_stats as $key => $stat) {
                                        if (stripos($stat['stat_name'], 'point') !== false || 
