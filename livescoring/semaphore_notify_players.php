...
$apiKey = 'fcc1970c7f8d7beca0ac40dce0cd4fcc'; // Replace with your actual Semaphore API key
...
function sendSemaphoreSMS($number, $message, $apiKey) {
    ...
    $parameters = [
        ...
        'message' => $message,
        'mode' => 'OTP'  // Try OTP mode for better delivery
    ];
...
try {
    ...
    $testNumber = "639887378278";
    
    writeToLog("Sending test message to $testNumber");
    $testResult = sendSemaphoreSMS($testNumber, $testMessage, $apiKey);
